...
export interface EcsStackProps extends cdk.StackProps {
    ...
    reportDbSecurityGroup: ec2.SecurityGroup;
    dbEndpoint: rds.Endpoint;
    reportDbEndpoint: rds.Endpoint;
...
export class EcsStack extends cdk.Stack {
    ...
    constructor(scope: Construct, id: string, props: EcsStackProps) {
        ...
        this.configureSecurityGroups(props, this.ecsSecurityGroup);
    ...
    private createTaskDefinition(props: EcsStackProps): ecs.FargateTaskDefinition {
        ...
        props.supersetSecret.grantRead(taskDefinition.taskRole);
        props.reportDbSecret.grantRead(taskDefinition.taskRole);
    ...
    private getContainerEnvironment(props: EcsStackProps): { [key: string]: string } {
        return {
            DB_HOST: props.dbEndpoint.hostname,
            DB_PORT: props.dbEndpoint.port.toString(),
            DB_NAME: 'superset',
            REPORTING_DB_HOST: props.reportDbEndpoint.hostname,
            REPORTING_DB_PORT: props.reportDbEndpoint.port.toString(),
    ...
    private getContainerSecrets(props: EcsStackProps): { [key: string]: ecs.Secret } {
        return {
            ...
            SUPERSET_SECRET_KEY: ecs.Secret.fromSecretsManager(props.supersetSecret, 'secret_key'),
            REPORTING_DB_USER: ecs.Secret.fromSecretsManager(props.reportDbSecret, 'username'),
            REPORTING_DB_PASSWORD: ecs.Secret.fromSecretsManager(props.reportDbSecret, 'password'),
        };
    }
    ...
    private configureSecurityGroups(props: EcsStackProps, ecsSecurityGroup: ec2.SecurityGroup): void {
        ...
        props.reportDbSecurityGroup.addIngressRule(
            ecsSecurityGroup,
            ec2.Port.tcp(5432),
