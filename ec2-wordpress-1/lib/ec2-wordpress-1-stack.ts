...
export class Ec2Wordpress1Stack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const dbInstance = new rds.DatabaseInstance(this, "WordpressRDS", {
      ...
      databaseName: "wordpressdb", // Create the database
    });
    ...
    userData.addCommands(
      ...
      "yum clean metadata",
      "yum install -y httpd php php-mysqlnd php-fpm wget unzip jq mysql",
      ...
      "    break",
      "  fi",
      '  echo "Attempt $i: Database not ready, waiting 30 seconds..."',
      "  sleep 30",
      "done",
    ...
    const ec2Instance = new ec2.Instance(this, "WordpressEC2", {
      ...
      keyPair: ec2.KeyPair.fromKeyPairName(
        this,
        "KeyPair",
        "yen-wipro-aws-dev-key-2"
      ), // <-- replace with your EC2 key pair name for SSH access
      role,
      userData,
